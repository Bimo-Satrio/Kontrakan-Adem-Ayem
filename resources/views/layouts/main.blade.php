...
<body>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="{{url('/backend/unitkontrakan')}}" class="sidebar-link">
                                <i class="bi bi-grid-1x2-fill"></i>
                                <span>Data Unit Kontrakan</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{url('/backend/penghuni-kontrakan')}}" class="sidebar-link">
                                <i class="bi bi-grid-1x2-fill"></i>
                                <span>Data Penghuni</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{url('/backend/bookingvalidation')}}" class="sidebar-link">
                                <i class="bi bi-grid-1x2-fill"></i>
        ...
        window.addEventListener('deleteConfirmation', event => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire('Hapus Dibatalkan', '', 'danger')
                }
            })
        })
    </script>
    ...
    <script>
        window.addEventListener('edit-sucess', event => {
            Swal.fire(
                ...
                // Redirect the user
                window.location.href = "{{url('/backend/unitkontrakan')}}";
            });
        })
    </script>
    ...
    <script>
        window.addEventListener('deletesucess', event => {
            Swal.fire(
                'Berhasil Terhapus !',
                'Unit Kontrakan Berhasil Terhapus',
                'success',
            );
        })
    </script>
