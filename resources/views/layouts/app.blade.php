    ...
    <div class="card-body">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="home-tab" href="/" aria-selected="true">Beranda</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="profile-tab" href="#profile" aria-selected="true">Tentang Adem Ayem</a>
            </li>

            @guest
            @if (Route::has('login'))
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="contact-tab" href="{{ route('login') }}" aria-selected="true">{{ __('Login') }}</a>
            </li>
            @endif
            @if (Route::has('register'))
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="contact-tab" href="{{ route('register') }}" aria-selected="true">{{ __('Register') }}</a>
            </li>
            @endif
            @else
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="contact-tab" href="{{url('/TransaksiUser')}}">Transaksi Saya</a>
            </li>
            ...
            <div class="btn-group mb-1">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonIcon">
                        <a class="dropdown-item" href="{{ route('profile') }}"><i class="bi bi-bar-chart-alt-2 me-50"></i>
                            Profile Saya</a>
                        <a class="dropdown-item" href="" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class=" bi bi-bell me-50"></i> {{ __('Logout') }}</a>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
                    </div>
